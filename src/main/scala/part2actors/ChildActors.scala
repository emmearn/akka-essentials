...
object ChildActors extends App {
  ...
  object CreditCard {
    case class AttachToAccount(bankAccount: NaiveBankAccount) // !! we need to do "bankAccount: ActorRef"
  ...
  class CreditCard extends Actor {
    ...
    def attachedTo(account: NaiveBankAccount): Receive = {
      case CheckStatus =>
        ...
        // benign
        account.withdraw(1) // bacause I can
    }
  }
